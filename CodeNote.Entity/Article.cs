...
namespace CodeNote.Entity
{
    ...
    public class Article
    {
        ...
        [Column(Name = "Body", DbType = "text", UpdateCheck = UpdateCheck.Never, CanBeNull = false)]
        public string Body
        {
        ...
        [Column(Name = "CategoryID", DbType = "nvarchar", UpdateCheck = UpdateCheck.Never, CanBeNull = false)]
        ...
        private string _tag;
        [Column(Name = "Tag", DbType = "nvarchar", UpdateCheck = UpdateCheck.Never, CanBeNull = false)]
        public string Tag
        {
        ...
        [Column(Name = "CreateDate", DbType = "datetime", UpdateCheck = UpdateCheck.Never, CanBeNull = false)]

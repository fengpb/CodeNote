<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<LoginUser>" %>

<%@ Import Namespace="CodeNote.Entity" %>
<%@ Import Namespace="CodeNote.Web.Common" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    A Pure Boy: Edit Account
</asp:Content>
...
<asp:Content ID="leftbox" ContentPlaceHolderID="LeftBox" runat="server">
    <div class="magtlf10 mgt10">
        ...
        <dl class="dlinput">
            ...
            <dd>
                <input id="email" disabled="disabled" name="" type="text" value="<%= Model!=null?Model.Email:"" %>"
                    class="text" />
                <input id="hidemail" type="hidden" name="email" value="<%= Model!=null?Model.Email:"" %>" />
            </dd>
        </dl>
        <dl class="dlinput">
            <dt>
            ...
            <dd>
                <% if (Model != null && Model.Type == (int)CodeNote.Web.Models.Constans.UserType.NoReg)
                   { %>
                <input id="oldpassword" name="oneoldpassword" readonly="readonly" type="text" value="<%= Model.PassWord %>"
                    class="text" />
...
<asp:Content ID="bot" ContentPlaceHolderID="BodyBottomContent" runat="server">

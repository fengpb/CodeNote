    ...
    <dl class="edit">
        ...
        <dd>
            <div class="wmd-panel">
                ...
                <textarea id="wmd-input" class="wmd-input abody" name="body" cols="50" rows="10"><%= Model!=null?Model.Body:"" %></textarea>
            </div>
            <div id="wmd-preview" class="wmd-panel wmd-preview content">
            </div>
        </dd>
        <dt>
        ...
        -->
        <dd class="btndiv">
            <input type="submit" id="savearticle" class="button" value=" 保&nbsp;存 " />
        </dd>
    </dl>
    <% Html.EndForm(); %>
</div>
